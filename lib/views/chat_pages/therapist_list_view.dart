import 'package:firebase_auth/firebase_auth.dart'
    as firebase_auth; // Alias Firebase Auth User class
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          itemCount: therapistController.therapists.length,
          itemBuilder: (context, index) {
            final therapist = therapistController.therapists[index];
            ...
            return GestureDetector(
              onTap: () async {
                ...
                if (firebaseUser != null) {
                  ...
                  BackendUser? matchedUser = userController.users.firstWhere(
